...
//			for (int i = 0; i < foundMap.Roots.Count; i++)
//			{
//				var root = foundMap.Roots[i];

//				// check if its regular
//				var levelIndex = foundMap.Levels.FindIndex(x => x.Item1 == root.Key);

//				var instance = PrefabUtility.InstantiatePrefab(levelIndex >= 0 ? _levelTile : _regularTile,
//					Selection.activeTransform) as GameObject;

//				Debug.Assert(instance != null, nameof(instance) + " != null");

//				instance.name = levelIndex >= 0 ? foundMap.Levels[levelIndex].Item2 : root.Key.ToString();

//				RegisterTile(instance, root.Key, root);
//				// adjust bounds
//				AdjustBounds(instance);

//				if (levelIndex >= 0)
//				{
//					ConfigureRequestHandler(instance, foundMap.Levels[levelIndex].Item2);
//				}
//			}
...
//					ConfigureRequestHandler(instance, levelName);
//				}
//			}
...
//		private static void ConfigureRequestHandler(GameObject instance, string levelName)
//		{
//			var details = instance.GetComponentInChildren<LevelNameRequestHandler>();
//			details.RawName = levelName;
//		}

//		private void RegisterTile(GameObject instance, int key, RootTile root = null)
//		{
//			_controllers.Add(instance, new TileController());
//			_indexes.Add(key, instance);

//			if (root != null) _currentMap.Roots.Add(root);
//		}

//		private void AdjustBounds(GameObject instance)
//		{
//			var boxCollider = instance.GetComponentInChildren<BoxCollider>();
//			_controllers[instance].AdjustBounds(boxCollider.bounds);
//		}
