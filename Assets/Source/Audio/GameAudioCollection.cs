...
namespace TilesWalk.Audio
{
    ...
    public class GameAudioCollection
    {
        ...
        /// <summary>
        /// Returns the linked <see cref="AudioClip"/> from a game audio entry.
        /// </summary>
        /// <param name="type"></param>
        /// <param name="identifier"></param>
        /// <returns></returns>
        public AudioClip GetAudioClip(GameAudioType type, string identifier)
        {
            var indexOf = -1;
            ...
            switch (type)
            {
                case GameAudioType.Music:
                    ...
                    if (indexOf >= 0)
                    {
                        return _gameMusic[indexOf].Clip;
                    }
                ...
                case GameAudioType.Sound:
                    ...
                    if (indexOf >= 0)
                    {
                        return _gameSounds[indexOf].Clip;
                    }
                ...
                case GameAudioType.UI:
                    ...
                    if (indexOf >= 0)
                    {
                        return _gameUISounds[indexOf].Clip;
                    }
